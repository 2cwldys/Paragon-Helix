...
Schema.voices.Add("Combine", "GOT ONE ACCOMPLICE", "I got one accomplice here!", "npc/metropolice/vo/gotoneaccompliceherea.wav")
...
Schema.voices.Add("Combine", "PROSECUTING", "Prosecuting.", "npc/combine_soldier/vo/procecuting.")
...
Schema.voices.Add("Combine", "STINGER", "Stinger.", "npc/combine_soldier/vo/stringer.wav")
...
Schema.voices.Add("Combine", "SUSPECT MOVED TO", "Suspect has moved now to...", "npc/metropolice/vo/supsecthasnowmovedto.wav")
...
Schema.voices.Add("Combine", "VISUAL EXOGEN", "Visual on exogen.", "npc/combine_soldier/vo/visualonexogen.wav")
...
Schema.voices.Add("Combine", "Roger", "Roger Roger.", "weapons/droid/roger.mp3")
Schema.voices.Add("Combine", "Ohoh", "Oh oh.", "weapons/droid/ohoh.mp3")
Schema.voices.Add("Combine", "Fire", "Prepare to fire.", "weapons/droid/fire.mp3")
